                  ...
                  @method('PUT')
                    ...
                    <div class="col-md-6">                  
                      <div class="form-group mb-3">
                        ...
                        <input type="text" id="example-email" name="follow_item_id" class="form-control" value="{{$item->follow_item_id}}"placeholder="{{__('keywords.follow_item_id')}}">
                      </div>     
                    ...
                    <div class="col-md-6">                  
                      <div class="form-group mb-3">
                        ...
                        <input type="text" id="example-email" name="calc_fl" value="{{$item->calc_fl}}" class="form-control" placeholder="{{__('keywords.calc_fl')}}">
                      </div>
                      @error('calc_fl')
                      <span class="text-danger">{{$message}}</span>
                      @enderror                   
